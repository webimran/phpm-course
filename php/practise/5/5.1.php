<?php 
    include_once "5.1.f.php";
    $task = $_GET['task'] ?? 'encode';
    $key = "abcdefghijklpnopqrstuvwxyz1234567890";
        ...
        <div class="container">
            <div class="row">
                <div class="column column-60 column-offset-20">
                    ...
                    <p>
                        <a href="/5.1.php?task=encode">Encode</a> | 
                        <a href="/5.1.php?task=decode">Decode</a> |
                        <a href="/5.1.php?task=key">Generate Key</a>
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="column column-60 column-offset-20">
                    <form action="5.1.php<?php if('decode' == $task){ echo "?task=decode"; }?>" method="POST">
